        ...
        <main className="overflow-hidden rounded-lg bg-white shadow-lg dark:bg-gray-800">
          ...
          <div className="grid gap-6 p-6 md:grid-cols-2">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2 border-t border-gray-200 pt-4 dark:border-gray-700"><ForceCurvesButton masterSwitchId={share.masterSwitchId} switchName={share.name} manufacturer={share.manufacturer || null} variant="button" className="w-full justify-center" isAuthenticated={false} /><SwitchScoresButton switchName={share.name} manufacturer={share.manufacturer || null} variant="button" className="w-full justify-center" /></div>
            </div>
          </div>
        </main>
