...
export const SWITCH_TECHNOLOGY_COLORS = {
  MECHANICAL: 'bg-green-100 text-green-900 dark:bg-green-800 dark:text-green-200',
  OPTICAL: 'bg-yellow-100 text-yellow-900 dark:bg-yellow-800 dark:text-yellow-200',
  MAGNETIC: 'bg-pink-100 text-pink-900 dark:bg-pink-800 dark:text-pink-200',
  INDUCTIVE: 'bg-cyan-100 text-cyan-900 dark:bg-cyan-800 dark:text-cyan-200',
  ELECTRO_CAPACITIVE: 'bg-indigo-100 text-indigo-900 dark:bg-indigo-800 dark:text-indigo-200',
} as const;
