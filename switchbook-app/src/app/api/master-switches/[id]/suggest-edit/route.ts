...
const editSuggestionSchema = z.object({
  ...
  stem: optionalString,
  topHousingColor: optionalString,
  bottomHousingColor: optionalString,
  stemColor: optionalString,
  stemShape: optionalString,
  markings: optionalString,
    ...
    const editSuggestion = await prisma.masterSwitchEdit.create({
      data: {
        ...
        newData: {
          ...
          progressiveSpring: validated.progressiveSpring,
          doubleStage: validated.doubleStage,
          actuationForce: validated.actuationForce,
          tactileForce: validated.tactileForce,
          tactilePosition: validated.tactilePosition,
          ...
          stem: validated.stem,
          topHousingColor: validated.topHousingColor,
          bottomHousingColor: validated.bottomHousingColor,
          stemColor: validated.stemColor,
          stemShape: validated.stemShape,
