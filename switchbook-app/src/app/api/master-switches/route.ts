...
export async function GET(request: Request) {
  try {
    ...
    const where: Prisma.MasterSwitchWhereInput = {
      ...
      ...(topHousingColor && { topHousingColor: { contains: topHousingColor, mode: 'insensitive' } }),
      ...(bottomHousingColor && { bottomHousingColor: { contains: bottomHousingColor, mode: 'insensitive' } }),
      ...(stemColor && { stemColor: { contains: stemColor, mode: 'insensitive' } }),
      ...(markings && { markings: { contains: markings, mode: 'insensitive' } }),
