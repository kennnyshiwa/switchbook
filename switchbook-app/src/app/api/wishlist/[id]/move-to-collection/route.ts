    ...
    if (wishlistItem.masterSwitchId && wishlistItem.masterSwitch) {
      ...
      const newSwitch = await prisma.switch.create({
        data: {
          ...
          topHousingColor: wishlistItem.masterSwitch.topHousingColor,
          bottomHousingColor: wishlistItem.masterSwitch.bottomHousingColor,
          stemColor: wishlistItem.masterSwitch.stemColor,
          stemShape: wishlistItem.masterSwitch.stemShape,
          markings: wishlistItem.masterSwitch.markings,
