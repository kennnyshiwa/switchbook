          ...
          <div className="mt-16 max-w-2xl mx-auto">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gray-50 dark:bg-gray-900 text-gray-500 dark:text-gray-400">Community & Partners</span>
              </div>
            </div>
            ...
            <div className="mt-6 space-y-4">
              ...
              >
                ...
                <div className="text-left flex-1">
                  <div className="font-medium text-base">SwitchOddities</div>
                  <div className="text-sm text-gray-500 dark:text-gray-400">Thank you for providing switch samples and data for the community</div>
                </div>
              </a>
              ...
              >
                ...
                <div className="text-left flex-1">
                  <div className="font-medium text-base">ThereminGoat</div>
