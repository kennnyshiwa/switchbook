        ...
        <div className="flex flex-col items-center justify-center min-h-screen py-12">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-3 lg:gap-12">
            <div className="text-center">
              ...
              <h3 className="mt-6 text-lg font-medium text-gray-900">Catalogue Your Collection</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="mt-6 text-lg font-medium text-gray-900">Visualize Your Stats</h3>
              <p className="mt-2 text-base text-gray-500">
            ...
            <div className="text-center">
              ...
              <h3 className="mt-6 text-lg font-medium text-gray-900">Share with Others</h3>
              <p className="mt-2 text-base text-gray-500">
