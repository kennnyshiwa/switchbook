...
export default async function Page() {
  ...
  const reviews = await prisma.forceCurveReviewCase.findMany({ where: { status: 'OPEN' }, include: { masterSwitch: { select: { id: true, name: true, manufacturer: true, technology: true, type: true } }, catalogEntry: true }, orderBy: { createdAt: 'asc' } })
