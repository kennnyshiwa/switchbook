              ...
              <div key={switchItem.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {switchItem.technology === 'MAGNETIC' && (switchItem.initialForce || switchItem.totalTravel || switchItem.initialMagneticFlux || switchItem.bottomOutMagneticFlux || switchItem.magnetOrientation || switchItem.magnetPosition) && (
                      <div className="border-t border-gray-200 dark:border-gray-600 pt-2 mt-2">
